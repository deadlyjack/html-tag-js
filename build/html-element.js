...
function select(element) {
  ...
  var optoinsContainer = _html__WEBPACK_IMPORTED_MODULE_0__["div"]({
    className: '__options'
  });
  ...
  var height = opts.height || elementClient.height;
  var width = (opts.width || elementClient.width) + 20;
  ...
  for (var i = 0; i < options.length; ++i) {
    var option = _html__WEBPACK_IMPORTED_MODULE_0__["span"]({
      className: '__option',
      attr: {
  ...
  function show() {
    ...
    var _height = options.length * (height || 40);
